...
<body>
        ...
        <form method="post" action="/UpdateGift/${gift.id}">
          ...
          <ul class="form-style-1">
   			 ...
   			 <li><label>Gift  name <span class="required">*</span></label><input type="text" name="name"  value="${gift.name}" class="field-divided" />
</li>
                    
    <li>
        <label>Description <span class="required">*</span></label>
        <textarea name="description" id="field5" class="field-long field-textarea"> ${gift.description} </textarea>
    </li>
                    <li>
